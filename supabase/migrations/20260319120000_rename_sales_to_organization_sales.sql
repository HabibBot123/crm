-- Rename table sales to organization_sales
ALTER TABLE public.sales RENAME TO organization_sales;

-- Update dashboard_overview to use organization_sales
...
AS $function$
  SELECT
    ...
    COALESCE((
      SELECT sum(s.price) FROM public.organization_sales s
    ...
    COALESCE((
      ...
      FROM (
        ...
        FROM public.organization_sales s
