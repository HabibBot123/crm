      ...
      <div className="hidden w-1/2 bg-primary/5 lg:flex lg:flex-col lg:justify-between lg:p-12">
        ...
        <div>
          ...
          <p className="mt-3 text-muted-foreground leading-relaxed">
            Sign in to access your dashboard, manage your products, and grow your coaching business.
          </p>
        </div>
        <p className="text-sm text-muted-foreground">Trusted by 2,000+ coaches worldwide</p>
      </div>
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link href="/login/forgot-password" className="text-xs text-primary hover:underline">Forgot?</Link>
              </div>
