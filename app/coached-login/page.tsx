...
export default function CoachingLoginPage() {
    ...
    // If already logged in as coached user, redirect to target page
    useEffect(() => {
        if (!isLoading && user) {
            router.replace(next)
        }
    ...
    return (
        <div className="flex min-h-screen">
            {/* Left panel: context for coached users */}
            <div className="hidden w-1/2 bg-primary/5 lg:flex lg:flex-col lg:justify-between lg:p-12">
                ...
                <div>
                    ...
                    <p className="mt-3 text-muted-foreground leading-relaxed">
                        Sign in to find your programs, sessions, and resources shared by your coach. All
                        payments are handled securely via Stripe.
                    </p>
                </div>
                <p className="text-sm text-muted-foreground">
                    You&apos;re signing in as a student / coached client.
                </p>
            </div>
                ...
                <div className="w-full max-w-sm">
                    <div className="mb-8 text-center lg:text-left">
                        ...
                        <p className="mt-2 text-sm text-muted-foreground">
                            New here?{" "}
                            <Link href="/coached-signup" className="font-medium text-primary hover:underline">
