...
import { fetchCoachedEnrollments } from "@/lib/services/coached"
    ...
    <div className="space-y-6">
      ...
      <Card className="border-border">
        <CardContent className="p-6">
          ...
          {/* Stats: enrollments and active count */}
      ...
      {/* Enrollments / Purchase history + Billing portal per coach */}
      <Card className="border-border">
        <CardContent className="p-0">
          <div className="flex items-center justify-between border-b border-border px-4 py-3">
            <div className="flex items-center gap-2">
              <CreditCard className="h-4 w-4 text-muted-foreground" />
              <h3 className="text-sm font-semibold text-foreground">Enrollments & Billing</h3>
            </div>
