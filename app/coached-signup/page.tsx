...
export default function CoachingSignupPage() {
    ...
    return (
        <div className="flex min-h-screen">
            {/* Left panel: reassurance for coached users */}
            <div className="hidden w-1/2 bg-primary/5 lg:flex lg:flex-col lg:justify-between lg:p-12">
                ...
                <div>
                    ...
                    <p className="mt-3 text-muted-foreground leading-relaxed">
                        Join your coach, access your programs, and track your progress in one place. Your
                        purchases are securely handled by Stripe.
                    </p>
                    <ul className="mt-8 space-y-3">
                        {[
                            "Secure login to access your purchases",
                            "Your data stays private between you and your coach",
                            "Works for coaching, courses, and memberships",
                        ].map((item) => (
                ...
                <div className="w-full max-w-sm">
                    <div className="mb-8 text-center lg:text-left">
                        ...
                        <p className="mt-2 text-sm text-muted-foreground">
                            ...
                            <Link href="/coached-login" className="font-medium text-primary hover:underline">
                                Sign in
                            </Link>
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleEmailSignup} className="space-y-4">
                        ...
                        <p className="text-center text-xs text-muted-foreground">
                            By creating an account you agree to the terms and privacy policy shared by your coach.
                        </p>
                    </form>
                </div>
            </div>
